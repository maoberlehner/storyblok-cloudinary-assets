...
1. To begin, [fork this project], clone your fork, and add our upstream.
   ...
   git clone https://github.com/<your-username>/storyblok-cloudinary-assets
   # Navigate to the newly cloned directory
   cd storyblok-cloudinary-assets
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/maoberlehner/storyblok-cloudinary-assets
...
[already been reported]: https://github.com/maoberlehner/storyblok-cloudinary-assets/issues
[fork this project]:     https://github.com/maoberlehner/storyblok-cloudinary-assets/fork
